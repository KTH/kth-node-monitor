...
const works = (key, options) => getResponse(key, httpResponse.statusCodes.OK, options)

const failed = (key, options) => getResponse(key, httpResponse.statusCodes.SERVICE_UNAVAILABLE, options)
